...
const createBodyAnalysisReport = async (payload) => {
  const response = await axiosClient.post("/body-analysis/", payload, {
    useAuthorization: true,
  });
  return response.data;
};
...
export default { getAll, getDetail, createBodyAnalysisReport, download, remove };
