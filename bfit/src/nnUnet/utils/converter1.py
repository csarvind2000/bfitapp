...
# 5-class thigh segmentation labels
DEFAULT_THIGH_5CLASS_LABEL_MAP = {
    1: ('Bone',                           'T-28010', 'BONE'),
    2: ('Intramuscular Adipose Tissue',   'T-D3002', 'IMAT'),
    3: ('Subcutaneous Adipose Tissue',    'T-0F182', 'SSAT'),
    4: ('Muscle',                         'T-D3000', 'MUSCLE'),
    5: ('Organ',                          'T-D0050', 'ORGAN'),
}

# 47-class detailed thigh segmentation labels
DEFAULT_THIGH_47CLASS_LABEL_MAP = {
    1: ('Bone', 'T-28010', 'BONE'),
    2: ('Intramuscular Adipose Tissue', 'T-D3002', 'IMAT'),
    3: ('Subcutaneous Adipose Tissue', 'T-0F182', 'SAT'),
    4: ('Gluteus Maximus Left', 'T-D3000', 'GLUTEUS_MAXIMUS_L'),
    5: ('Gluteus Maximus Right', 'T-D3000', 'GLUTEUS_MAXIMUS_R'),
    6: ('Tensor Fascia Latae Left', 'T-D3000', 'TENSOR_FASCIA_LATAE_L'),
    7: ('Tensor Fascia Latae Right', 'T-D3000', 'TENSOR_FASCIA_LATAE_R'),
    8: ('Iliacus Left', 'T-D3000', 'ILIACUS_L'),
    9: ('Iliacus Right', 'T-D3000', 'ILIACUS_R'),
    10: ('Ilium Left', 'T-12310', 'ILIUM_L'),
    11: ('Ilium Right', 'T-12310', 'ILIUM_R'),
    12: ('Pectineus Left', 'T-D3000', 'PECTINEUS_L'),
    13: ('Pectineus Right', 'T-D3000', 'PECTINEUS_R'),
    14: ('Obturator Internus Left', 'T-D3000', 'OBTURATOR_INTERNUS_L'),
    15: ('Obturator Internus Right', 'T-D3000', 'OBTURATOR_INTERNUS_R'),
    16: ('Obturator Externus Left', 'T-D3000', 'OBTURATOR_EXTERNUS_L'),
    17: ('Obturator Externus Right', 'T-D3000', 'OBTURATOR_EXTERNUS_R'),
    18: ('Gemelli Quadratus Femoris Left', 'T-D3000', 'GEMELLI_QUADRATUS_FEMORIS_L'),
    19: ('Gemelli Quadratus Femoris Right', 'T-D3000', 'GEMELLI_QUADRATUS_FEMORIS_R'),
    20: ('Vastus Lateralis Left', 'T-D3000', 'VASTUS_LATERALIS_L'),
    21: ('Vastus Lateralis Right', 'T-D3000', 'VASTUS_LATERALIS_R'),
    22: ('Vastus Intermedius Left', 'T-D3000', 'VASTUS_INTERMEDIUS_L'),
    23: ('Vastus Intermedius Right', 'T-D3000', 'VASTUS_INTERMEDIUS_R'),
    24: ('Vastus Medialis Left', 'T-D3000', 'VASTUS_MEDIALIS_L'),
    25: ('Vastus Medialis Right', 'T-D3000', 'VASTUS_MEDIALIS_R'),
    26: ('Rectus Femoris Left', 'T-D3000', 'RECTUS_FEMORIS_L'),
    27: ('Rectus Femoris Right', 'T-D3000', 'RECTUS_FEMORIS_R'),
    28: ('Sartorius Left', 'T-D3000', 'SARTORIUS_L'),
    29: ('Sartorius Right', 'T-D3000', 'SARTORIUS_R'),
    30: ('Gracilis Left', 'T-D3000', 'GRACILIS_L'),
    31: ('Gracilis Right', 'T-D3000', 'GRACILIS_R'),
    32: ('Semimembranosus Left', 'T-D3000', 'SEMIMEMBRANOSUS_L'),
    33: ('Semimembranosus Right', 'T-D3000', 'SEMIMEMBRANOSUS_R'),
    34: ('Semitendinosus Left', 'T-D3000', 'SEMITENDINOSUS_L'),
    35: ('Semitendinosus Right', 'T-D3000', 'SEMITENDINOSUS_R'),
    36: ('Biceps Femoris Long Head Left', 'T-D3000', 'BICEPS_FEMORIS_LONG_HEAD_L'),
    37: ('Biceps Femoris Long Head Right', 'T-D3000', 'BICEPS_FEMORIS_LONG_HEAD_R'),
    38: ('Biceps Femoris Short Head Left', 'T-D3000', 'BICEPS_FEMORIS_SHORT_HEAD_L'),
    39: ('Biceps Femoris Short Head Right', 'T-D3000', 'BICEPS_FEMORIS_SHORT_HEAD_R'),
    40: ('Adductor Magnus Left', 'T-D3000', 'ADDUCTOR_MAGNUS_L'),
    41: ('Adductor Magnus Right', 'T-D3000', 'ADDUCTOR_MAGNUS_R'),
    42: ('Adductor Longus Left', 'T-D3000', 'ADDUCTOR_LONGUS_L'),
    43: ('Adductor Longus Right', 'T-D3000', 'ADDUCTOR_LONGUS_R'),
    44: ('Adductor Brevis Left', 'T-D3000', 'ADDUCTOR_BREVIS_L'),
    45: ('Adductor Brevis Right', 'T-D3000', 'ADDUCTOR_BREVIS_R'),
    46: ('Groin Region', 'T-D0050', 'GROIN_REGION'),
    47: ('Intermuscular Fat', 'T-D3002', 'IMF'),
}

DEFAULT_THIGH_LABEL_MAP = DEFAULT_THIGH_5CLASS_LABEL_MAP
...
class DicomSegConverter:
    ...
    def convert_nifti(self, nifti_path: str, output_path: str):
        ...
        elif seg_data.shape == (cols, rows, num_slices):
